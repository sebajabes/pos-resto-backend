...
<head>
    ...
    <title>Login &mdash; POS RESTO SEBAJ</title>
            ...
            <div class="d-flex align-items-stretch flex-wrap">
                <div class="col-lg-4 col-md-6 col-12 order-lg-1 min-vh-100 order-2 bg-white">
                    <div class="m-3 p-4">
                        ...
                        <h4 class="text-dark font-weight-normal">Welcome to <span class="font-weight-bold">POS RESTO
                                SEBAJ</span>
                        </h4>
                        ...
                        <div class="text-small mt-5 text-center">
                            Copyright &copy; Sebajabes. Made with 💙 by sebajabes
                            <div class="mt-2">
